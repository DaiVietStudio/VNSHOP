    ...
    class ProductController : BaseController
    {
        ...
        public Response exportExcel(string path)
        {
            try
            {
                ...
                row1.CreateCell(2).SetCellValue("Đơn vị tính");
                //row1.CreateCell(2).SetCellValue("Mô tả");
                //row1.CreateCell(3).SetCellValue("Giá nhập");
                row1.CreateCell(3).SetCellValue("Giá lẻ");
                ...
                foreach (var item in products)
                {
                    ...
                    DonViTinh_SanPham unit = item.DonViTinh_SanPham.Where(s => s.Selected == true).FirstOrDefault();
                    if(unit != null)
                    {
                        newRow.CreateCell(2).SetCellValue(unit.DonViTinh1.TenDonVi);
                        newRow.CreateCell(3).SetCellValue(unit.GiaLe.ToString());
